...
TARGET_DIR=/tmp/kieScripts/deploy/6.0.x/EAP6.1.1
SCRIPTS=/home/kiereleaseuser/daily-build/deploy/6.0.x/EAP6.1
...
cp $SCRIPTS/reinstall-eap-6.1.1.sh $TARGET_DIR
