...
TO_DROOLS=kiereleaseuser@hp-dl380pg8-01.lab.eng.brq.redhat.com:jboss_artifacts
TO_OPTAPLANNER=kiereleaseuser@hp-dl380pg8-01.lab.eng.brq.redhat.com:jboss_artifacts
