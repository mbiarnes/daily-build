...
##############################################################################################
#                                                                                            #
#        copies all created artifacts to /var/kie-artifacts/                                 #     
#                                                                                            #
##############################################################################################
#
#
...
cp $REPO_DIR/droolsjbpm-integration/kie-server-parent/kie-server-distribution/target/kie-server-distribution-*.zip $TARGET_DIR

#kie-server*.war
cp $REPO_DIR/droolsjbpm-integration/kie-server-parent/kie-server/target/kie-server*.war $TARGET_DIR
...
rm $TARGET_DIR/kie-server-services-*-javadoc.jar
rm $TARGET_DIR/kie-server-services-*-sources.jar
rm $TARGET_DIR/kie-server-services-*-tests.jar
