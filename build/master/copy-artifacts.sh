...
cp $GIT_DIR/dashboard-builder/builder/target/dashbuilder-*-eap6_3.war $ARTIFACT_DIR/new
...
cp $GIT_DIR/jbpm-dashboard/jbpm-dashboard-distributions/target/jbpm-dashbuilder-*-eap6_3.war $ARTIFACT_DIR/new
