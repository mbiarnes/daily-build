...
# dashbuilder
    ...
    scp dashbuilder-*-eap6_4.war drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/master/dashbuilder-$SFVER-eap6_4.war
...
# jbpm-dashboard
    ...
    scp jbpm-dashbuilder-*-eap6_4.war drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/master/jbpm-dashbuilder-$SFVER-eap6_4.war
...
# BPMS
    scp kie-wb-*-eap6_4.war drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/master/kie-wb-$SFVER-eap6_4.war
...
# BRMS
    scp kie-drools-wb-*-eap6_4.war drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/master/kie-drools-wb-$SFVER-eap6_4.war
...
scp kie-server-distribution-*.zip drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/master/kie-server-distribution-$SFVER.zip
