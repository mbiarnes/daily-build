...
# dashbuilder
    ...
    scp dashbuilder-*-weblogic-12c.war drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/6.2.x/dashbuilder-$SFVER-weblogic-12c.war
# jbpm-dashboard
    ...
    scp jbpm-dashbuilder-*-weblogic-12c.war drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/6.2.x/jbpm-dashbuilder-$SFVER-weblogic-12c.war
# BPMS
