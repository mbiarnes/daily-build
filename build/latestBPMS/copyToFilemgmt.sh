...
then
    ...
    scp dashbuilder-*-eap-6_1.war drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/6.2.x/dashbuilder-$SFVER-eap-6_1.war
    ...
    scp kie-wb-distribution-wars-*-bpms-webapp.war drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/6.2.x/kie-wb-distribution-wars-$SFVER-bpms-webapp.war
    scp jbpm-dashboard-distributions-*-bpms-webapp.war drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/6.2.x/jbpm-dashboard-distributions-$SFVER-bpms-webapp.war
    scp kie-drools-wb-distribution-wars-*-brms-webapp.war drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/6.2.x/kie-drools-wb-distribution-wars-$SFVER-brms-webapp.war
    ...
    scp jbpm-dashbuilder-*-eap-6_1.war drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/6.2.x/jbpm-dashbuilder-$SFVER-eap-6_1.war
    ...
    scp kie-drools-wb-*-wildfly.war drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/6.2.x/kie-drools-wb-$SFVER-wildfly.war
    ...
    scp kie-wb-*-wildfly.war.war drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/6.2.x/kie-wb-$SFVER-wildfly.war
    scp kie-drools-wb-*-wildfly.war drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/6.2.x/kie-drools-wb-$SFVER-wildfly.war
