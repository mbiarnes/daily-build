...
then
    ...
    scp eap-modules-distributions-*-bpms-layer.zip drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/6.1.x/eap-modules-distributions-$SFVER-bpms-layer.zip
    scp eap-modules-distributions-*-brms-layer.zip drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/6.1.x/eap-modules-distributions-$SFVER-brms-layer.zip
    scp eap-modules-distributions-*-org.jbpm.dashboard.jbpm-dashboard.war drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/6.1.x/eap-modules-distributions-$SFVER-org.jbpm.dashboard.jbpm-dashboard.war
    scp eap-modules-distributions-*-org.kie.kie-drools-wb-webapp.war drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/6.1.x/eap-modules-distributions-$SFVER-org.kie.kie-drools-wb-webapp.war
    scp eap-modules-distributions-*-org.kie.kie-wb-webapp.war drools@filemgmt.jboss.org:/downloads_htdocs/drools/release/snapshot/6.1.x/eap-modules-distributions-$SFVER-org.kie.kie-wb-webapp.war
